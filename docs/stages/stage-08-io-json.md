# Stage 08 - 文件、路径、JSON、序列化、配置

## 目标

本阶段围绕：文件、路径、JSON、序列化、配置。
...
| Python 关注点 | Java 类比 |
| --- | --- |
| 文件、路径、JSON、序列化、配置 | Path、Jackson、配置类 |
...
1. 运行 `uv run python -m iron_python_learning_lab 8`。

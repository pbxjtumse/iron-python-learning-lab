# Stage 06 - 集合、迭代器、生成器、推导式

## 目标

本阶段围绕：集合、迭代器、生成器、推导式。
...
| Python 关注点 | Java 类比 |
| --- | --- |
| 集合、迭代器、生成器、推导式 | Collections、Iterator、Stream |
...
1. 运行 `uv run python -m iron_python_learning_lab 6`。

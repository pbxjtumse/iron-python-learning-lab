# Stage 01 - 基础语法、控制流、异常、模块

## 目标

本阶段围绕：基础语法、控制流、异常、模块。
...
| Python 关注点 | Java 类比 |
| --- | --- |
| 基础语法、控制流、异常、模块 | Java 语法、工具类、checked exception |
...
- 不要把 is 当成 ==；Python 没有 checked exception。
...
1. 运行 `uv run python -m iron_python_learning_lab 1`。

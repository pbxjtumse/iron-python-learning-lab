# Stage 09 - 并发、线程、asyncio、TaskGroup

## 目标

本阶段围绕：并发、线程、asyncio、TaskGroup。
...
| Python 关注点 | Java 类比 |
| --- | --- |
| 并发、线程、asyncio、TaskGroup | 线程池、CompletableFuture |
...
1. 运行 `uv run python -m iron_python_learning_lab 9`。

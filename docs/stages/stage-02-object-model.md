# Stage 02 - 对象模型、引用、可变/不可变、拷贝

## 目标

本阶段围绕：对象模型、引用、可变/不可变、拷贝。
...
| Python 关注点 | Java 类比 |
| --- | --- |
| 对象模型、引用、可变/不可变、拷贝 | Java 引用变量、String、浅拷贝/深拷贝 |
...
1. 运行 `uv run python -m iron_python_learning_lab 2`。

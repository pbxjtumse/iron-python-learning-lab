# Stage 04 - 函数、参数、模块、包、import

## 目标

本阶段围绕：函数、参数、模块、包、import。
...
| Python 关注点 | Java 类比 |
| --- | --- |
| 函数、参数、模块、包、import | 方法、重载、Maven module |
...
- Python 没有 Java 风格方法重载；可变默认参数要小心。
...
1. 运行 `uv run python -m iron_python_learning_lab 4`。
